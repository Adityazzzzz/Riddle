    ...
    <div className="min-h-screen bg-[#FDFDFB] text-[#222228] selection:bg-amber-100 selection:text-amber-900 relative overflow-hidden font-sans">
      ...
      <header className="max-w-6xl mx-auto px-8 py-10 flex justify-between items-center relative z-20">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="text-stone-500 hover:text-stone-850 hover:bg-stone-100/80 transition-all flex items-center gap-1.5 text-[10px] font-medium border border-stone-200 bg-stone-50/50 px-3 py-1.5 rounded-full shadow-sm"
          >
          ...
          {visits !== null && (
            <span className="text-[10px] font-medium text-stone-500 tracking-wider bg-stone-100 px-3 py-1.5 rounded-full flex items-center gap-1.5 border border-stone-200/60 uppercase">
      ...
      <main className="max-w-6xl mx-auto px-8 pt-6 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-6 flex flex-col items-start text-left">
          ...
          {/* Made by tag with float animation */}
          <div className="mt-8">
            <div className="inline-flex items-center gap-2 bg-amber-500/5 border border-amber-500/10 px-3.5 py-1 rounded-full text-[10px] font-bold text-amber-800 tracking-widest uppercase cursor-default select-none animate-bounce shadow-sm" style={{ animationDuration: '3.5s' }}>
              <span>🪄</span>
              <span>made by adityazzzz</span>
            </div>
          </div>
        </div>
